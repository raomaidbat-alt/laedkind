  ...
  return (
    <div className="container mx-auto flex items-center justify-between gap-4 py-3 md:py-4 px-4 md:px-6">
      ...
      <div className="hidden lg:flex items-center gap-6">
        ...
        <a 
          href="https://t.me/pokeroho" 
          target="_blank" 
          rel="noopener noreferrer" 
          className="flex items-center gap-2 text-[10px] font-bold text-slate-400 hover:text-[#00D9A3] transition-colors tracking-widest uppercase"
        >
          Свой запрос
    ...
    <div className="min-h-screen text-[#E8EDF2] pb-20 overflow-x-hidden selection:bg-[#00D9A3]/20">
      ...
      <section id="feedback" className="reveal container mx-auto px-6 py-32 max-w-5xl">
        <div className="bg-[#0D1B2E]/60 border border-[#00D9A3]/20 rounded-[4rem] p-12 sm:p-20 text-center relative overflow-hidden shadow-[0_0_100px_rgba(0,217,163,0.05)]">
          ...
          <p className="text-slate-400 text-lg mb-12 max-w-lg mx-auto leading-relaxed reveal">Разработаем индивидуальную логику под ваши бизнес-задачи любой сложности. Свяжитесь напрямую для обсуждения проекта.</p>
          <div className="flex justify-center reveal">
            <a 
              href="https://t.me/pokeroho" 
              target="_blank" 
              rel="noopener noreferrer"
              className="btn-premium text-[#0A1628] px-12 py-5 rounded-2xl font-bold text-sm whitespace-nowrap uppercase tracking-widest flex items-center gap-3"
            >
